...
export function Strengths({ result }: { result: AnalysisResult }) {
  return (
    <section className="card-surface p-6 sm:p-8">
      <h2 className="font-display text-xl font-semibold">O que está funcionando</h2>
...
export function Improvements({ result }: { result: AnalysisResult }) {
  return (
    <section className="card-surface p-6 sm:p-8">
      <h2 className="font-display text-xl font-semibold">O que você deve melhorar</h2>
      <ul className="mt-5 space-y-4">
      ...
      <p className="mt-6 flex gap-2.5 text-xs text-muted-foreground">
        ...
        As recomendações nunca pedem que você reivindique habilidades que não possui. Quando um
        requisito estiver ausente, aprenda-o, destaque experiências relacionadas ou explique como
        sua experiência se aplica.
      </p>
    </section>
  );
}
  ...
  return (
    <section className="card-surface p-6 sm:p-8">
      <div className="flex items-center gap-2.5">
        ...
        <h2 className="font-display text-xl font-semibold">Insights de Carreira</h2>
      </div>
      <p className="mt-1 text-sm text-muted-foreground">
        Sugestões geradas por IA com base no seu currículo e na vaga desejada.
      </p>
